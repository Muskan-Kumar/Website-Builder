    ...
    <div className='relative min-h-screen bg-[#040404] text-white overflow-hidden'>
        ...
        <div className='max-w-7xl mx-auto px-6 py-4 flex justify-between items-center'>
            ...
            <div className='flex items-center gap-5'>
                <div className='hidden md:inline text-sm text-zinc-400 hover:text-while cursor-pointer' onClick={()=>navigate("/pricing")}>
                    Pricing
                </div>
                ...
                onClick={()=>setOpenLogin(true)}>Get Started</button>
                 ...
                 <button className='flex item-center' onClick={()=>setOpenProfile(!openProfile)}>
                    <img className='w-9 h-9 rounded-full border border-white/20 object-cover' 
                    src={userData?.avatar || `https://ui-avatars.com/api/?name=${userData.name}`} alt="" referrerPolicy='no-referrer'
                    />
                </button>
                <AnimatePresence>
                    {openProfile && (
                        ...
                        scale={{opacity:0, y:-10, scale: 0.95}}
                        ...
                        >
                            ...
                            <button className='w-full px-4 text-left text-sm hover:bg-white/5' onClick={()=>navigate("/dashboard")}>Dashboard</button>
