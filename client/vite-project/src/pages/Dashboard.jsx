                        ...
                        return <motion.div
                         ...
                         >
                            <div className='relative h-40 bg-black cursor-pointer'>
                                <iframe srcDoc={w.latestCode} sandbox="allow-scripts allow-forms" className='absolute inset-0 w-[140%] h-[140%] scale-[0.72] origin-top-left pointer-events-none bg-white'/>
                            ...
                            <div className='p-5 flex flex-col gap-4 flex-1'>
                                ...
                                {!w.deployed ? (
                                    <button className='mt-auto flex item-center justify-center gap-2 px-4 py-2 rounded-xl
                                    text-sm font-semibold bg-gradient-to-r from-indigo-500 to-purple-500 hover:scale-105 transition'
