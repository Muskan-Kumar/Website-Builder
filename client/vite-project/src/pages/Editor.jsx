...
// import { Code2, Monitor, Rocket, Send, X, MessageSquare} from 'lucide-react'
...
//   if(error){
//     return(
//       <div className='h-screen flex items-center justifycenter bg-black text-red-400'>
//         {error}
//       </div>
//     )
//   }
...
//               <input placeholder='Describe Change...' className='flex-1 resize-none rounded-2xl px-4 py-3 bg-white/5 border border-white/10 text-sm outline-none'
//               onChange={(e)=>setPrompt(e.target.value)} value={prompt}/>
              
//               <button className='px-4 py-3 rounded-2xl bg-white text-black' disabled={updateLoading} onClick={handleUpdateWebsite}><Send size={14}/></button>
//             </div>
//           </div>
//       </>
//       </aside>
...
//             <button onClick={()=>setShowFullPreview(false)} className='absolute top-4 right-4 p-2 bg-black/70 rounded-lg'>
//               <X />
//             </button>
//           </motion.div>
//         )}
